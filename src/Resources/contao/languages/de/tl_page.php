...
$GLOBALS['TL_LANG']['tl_page']['cleverreach_legend'] = 'Cleverreach Connect';

/*
 * Fields
 */
$GLOBALS['TL_LANG']['tl_page']['cleverreachConnect'] = ['Cleverreach Connect aktivieren', 'Klicken Sie hier um die Verbindung zu Cleverreach zu konfigurieren.'];
